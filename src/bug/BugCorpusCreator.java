...
public class BugCorpusCreator {
	...
	/**
	 * Write all the words of a bug to the target directory
	 * @param bug
	 * @param storeDir
	 * @throws IOException
	 */
	...
	/**
	 * Parse the target XML file containing the bug report into an Arraylist of bugs
	 * @return
	 */
	...
	/**
	 * export textual descriptions of every bug to documents
	 * sort the bugs in the time order
	 * extract the file names
	 * extract all the class names within each file
	 * @throws IOException
	 */
	public void create() throws IOException {
		...
		//SortedID.txt saves all the bugs sorted in the time order
		FileWriter writer = new FileWriter(Property.getInstance().getWorkDir()
				+ Property.getInstance().getSeparator() + "SortedId.txt");
		
		//Fixlink.txt saves the files that are fixed to resolve the bug sorted in the time order 
		FileWriter writerFix = new FileWriter(Property.getInstance()
				.getWorkDir()
				+ Property.getInstance().getSeparator()
				+ "FixLink.txt");
		
		//DescriptionClassName.txt saves all the class names mentioned in a bug report
